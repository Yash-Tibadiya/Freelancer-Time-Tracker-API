...
const options = {
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        Task: {
          type: "object",
          required: ["name", "description", "assignedTo", "startTime", "endTime"],
          properties: {
            name: {
              type: "string",
  ...
  apis: [], // We're defining everything manually
};

const specs = swaggerJsdoc(options);
writeFileSync("./src/swagger-output.json", JSON.stringify(specs, null, 2));
